...
$proxy = new soapclient('http://sna-srv-tst-04.mobileline.com/store/api/soap/?wsdl');
...
//try{			 
	//$arr = array(array('LGP-VX10KS' => array('qty' => 1), 'MA-89170' => array('qty' => 2), 'WEB FULFILLMENT FEE' => array('qty' => 1)));
//print_r($orderData);
...
//$resultarr = xml2array($result);
print_r($result);
//echo "<br><br>next<br><br>";
//echo "<br>REQUEST**<BR>".$proxy->__getLastRequest();
//echo "<br>RESPONSE**<BR>".$proxy->__getLastResponse();
//var_dump($result);
?>
