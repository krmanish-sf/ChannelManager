...
public interface SupplierRepository {
  ...
  VendorSupplier update(int vendorSupplierId, Map<String, String> vendorSupplierData);

  VendorSupplier removeSubscription(Integer vendorSupplierId);

  List<Supplier> findUnsubscribed();

  VendorSupplier addSubscription(Integer supplierId, String login, String password,
      String accountno, String defShippingMc, Integer testmode);

  VendorSupplier addSubscriptionHG(Integer supplierId, String phi_login, String phi_password,
  ...
  List<SupplierShippingMethod> findChannelShippingForSupplierCarrier(Integer supplierId,
      Integer shippingCarrierId);

  void deleteShippingOverrideForSupplierMethod(int id);

  List<SupplierShippingMethod> saveShippingOverrideForSupplierMethod(Integer integer,
      String string);
  ...
  VendorSupplier addSubscriptionWithFtpDetails(Integer supplierId, String string, String string2,
      String string3, String string4, Integer testMode, String isSftp, String accountNumber);
