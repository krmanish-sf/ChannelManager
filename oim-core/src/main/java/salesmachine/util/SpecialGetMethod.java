...
public class SpecialGetMethod extends GetMethod {
	private static final Log log = LogFactory.getLog(SpecialGetMethod.class);
	public SpecialGetMethod(String something) {
		super(something);
	}
