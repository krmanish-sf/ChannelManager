...
public class ApplicationProperties {
	...
	/**
	 * Returns Automation Thread Pool Size specified by key
	 * {@code AUTOMATION_THREAD_POOL_SIZE} in {@link ApplicationProperties}. If
	 * the above mentioned key is not found or can't be parsed as Integer;
	 * Default value 3 is returned.
	 * 
	...
	/**
	 * Returns Order pull interval specified by key
	 * {@code AUTOMATION_ORDER_PULL_INTERVAL} in {@link ApplicationProperties}
	 * if the above mentioned key is not found or can't be parsed as long;
	 * Default value 3600000 is returned.
	 * 
	 * @return long value containing order pull interval (in milliseconds)
	 */
	...
	/**
	 * Returns Order tracking interval specified by key
	 * {@code AUTOMATION_ORDER_TRACK_INTERVAL} in {@link ApplicationProperties}
	 * if the above mentioned key is not found or can't be parsed as long;
	 * Default value 3600000 is returned.
	 * 
	...
	/**
	 * Returns Hostname as resolved by {@link
	 * java.net.InetAddress.getHostName()}
	 * 
	 * @return String value containing the above value returned by above method,
	 *         if an exception is encountered {@value "Unknown"} is returned.
	 */
