...
public class VolusionShippingCodeMapWithIS {
  //shipping_carrier_method_for_volusion.properties
  ...
  static {
    try {
      String filename = "shipping_carrier_method_for_volusion.properties";
