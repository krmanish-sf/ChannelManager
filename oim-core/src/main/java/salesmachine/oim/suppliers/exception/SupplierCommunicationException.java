...
public class SupplierCommunicationException extends Exception {
     ...
     */
    public SupplierCommunicationException() {
        super();
    }
     ...
     * 
     */
    public SupplierCommunicationException(Throwable cause) {
        super(cause);
    }
     ...
     * 
     */
    protected SupplierCommunicationException(String message, Throwable cause,
