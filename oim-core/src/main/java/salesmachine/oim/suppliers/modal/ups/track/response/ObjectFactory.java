 ...
 * generated in the salesmachine.oim.suppliers.modal.ups.track.response package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: salesmachine.oim.suppliers.modal.ups.track.response
     * 
     */
