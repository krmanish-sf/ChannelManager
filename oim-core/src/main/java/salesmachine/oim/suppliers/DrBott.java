...
public class DrBott extends Supplier {
	...
	public void sendOrders(Integer vendorId, OimVendorSuppliers ovs, List orders) {
		...
		for (int i = 0; i < orders.size(); i++) {
			...
			for (Iterator detailIt = order.getOimOrderDetailses().iterator(); detailIt
				...
				successfulOrders.put(detail.getDetailId(), new OrderDetailResponse()); // TODO get PO
																// and status
																// insert into
																// parametrised
																// constructor
	...
	private List getFileFieldMap() {
		...
		String fields[] = { "CustomerShipID", "CustomerPO", "CustomerRef",
				"PODate", "ShipToName", "ShipToAttn", "ShipToAddress1",
				"ShipToAddress2", "ShipToCity", "ShipToState", "ShipToZip",
				"ShipToCountry", "ShipToPhone", "BillToName", "BillToAttn",
				"BillToAddress1", "BillToAddress2", "BillToCity",
				"BillToState", "BillToZip", "BillToCountry", "BillToPhone",
				"ShippingMethod", "ProductCode", "ProductDescShort",
				"ProductQuanity", "ProductUPC", "ShipmentBillingType",
				"ShipmentBillingAccount", };
		Integer mappedFieldIds[] = { 2, 2, 0, 14, 3, 0, 4, 0, 5, 6, 7, 8, 30,
				3, 0, 4, 0, 5, 6, 7, 8, 30, 10, 1, 0, 9, 0, 0, 0 };
