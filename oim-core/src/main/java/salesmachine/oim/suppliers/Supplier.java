...
public abstract class Supplier {
  ...
  public abstract void sendOrders(Integer vendorId, OimVendorSuppliers ovs, OimOrders orders)
  ...
  public static final void updateVendorSupplierOrderHistory(Integer vid, OimSuppliers oimSuppliers,
      Object response, int errorCode) {
    updateVendorSupplierOrderHistory(vid, oimSuppliers, response, errorCode, null);
  }

  public static final void updateVendorSupplierOrderHistory(Integer vid, OimSuppliers oimSuppliers,
      Object response, int errorCode, OimOrderDetails oimOrderDetails) {
  ...
  public static List<OimSupplierShippingMethod> loadSupplierShippingMap(OimSuppliers s, Vendors v) {
    Session dbSession = SessionManager.currentSession();
    @SuppressWarnings(value = { "unchecked" })
    List<OimSupplierShippingMethod> methods = dbSession
        .createCriteria(OimSupplierShippingMethod.class).add(Restrictions.eq("oimSupplier", s))
        .list();
    return methods;
  }
  ...
  protected static OimSupplierShippingMethod findShippingCodeFromUserMapping(
      List<OimSupplierShippingMethod> shippingMethods, OimShippingMethod shippingDetails) {
    for (OimSupplierShippingMethod oimSupplierShippingMethod : shippingMethods) {
      if (oimSupplierShippingMethod.getOimShippingMethod().getName()
          ...
          && oimSupplierShippingMethod.getOimShippingCarrier().getName()
              .equalsIgnoreCase(shippingDetails.getOimShippingCarrier().getName())) {
  ...
  @Deprecated
  public static String findShippingCodeFromUserMapping(HashMap shippingMethods,
  ...
  public static String findShippingCodeFromSuggested(HashMap shippingMethods,
    ...
    while (shipMethodsIt.hasNext()) {
      ...
      if (shippingDetails.contains(key)) {
        HashMap detailedShippingMethods = (HashMap) shippingMethods.get(key);
