			...
			do {
				...
				for (Order order2 : orderList) {
					...
					if (order2.getShippingAddress() != null) {
						oimOrders.setBillingCity(StringHandle.removeComma(order2.getShippingAddress()
								.getCity()));
						oimOrders.setBillingCompany(StringHandle.removeComma(order2.getShippingAddress()
								.getAddressLine3()));
						oimOrders.setBillingCountry(StringHandle.removeComma(order2.getShippingAddress()
								.getCounty()));
						oimOrders.setBillingEmail(StringHandle.removeComma(order2.getBuyerEmail()));
						oimOrders.setBillingName(StringHandle.removeComma(order2.getShippingAddress()
								.getName()));
						oimOrders.setBillingPhone(StringHandle.removeComma(order2.getShippingAddress()
								.getPhone()));
						oimOrders.setBillingState(StringHandle.removeComma(order2.getShippingAddress()
								.getStateOrRegion()));
						oimOrders.setBillingStreetAddress(StringHandle.removeComma(order2
								.getShippingAddress().getAddressLine1()));
						oimOrders.setBillingSuburb(StringHandle.removeComma(order2.getShippingAddress()
								.getAddressLine2()));
						oimOrders.setBillingZip(StringHandle.removeComma(order2.getShippingAddress()
								.getPostalCode()));

						oimOrders.setCustomerCity(StringHandle.removeComma(order2.getShippingAddress()
								.getCity()));
						oimOrders.setCustomerCompany(StringHandle.removeComma(order2
								.getShippingAddress().getAddressLine3()));
						oimOrders.setCustomerCountry(StringHandle.removeComma(order2
								.getShippingAddress().getCounty()));
						oimOrders.setCustomerEmail(StringHandle.removeComma(order2.getBuyerEmail()));
						oimOrders.setCustomerName(StringHandle.removeComma(order2.getShippingAddress()
								.getName()));
						oimOrders.setCustomerPhone(StringHandle.removeComma(order2.getShippingAddress()
								.getPhone()));
						oimOrders.setCustomerState(StringHandle.removeComma(order2.getShippingAddress()
								.getStateOrRegion()));
						oimOrders.setCustomerStreetAddress(StringHandle.removeComma(order2
								.getShippingAddress().getAddressLine1()));
						oimOrders.setCustomerSuburb(StringHandle.removeComma(order2.getShippingAddress()
								.getAddressLine2()));
						oimOrders.setCustomerZip(StringHandle.removeComma(order2.getShippingAddress()
								.getPostalCode()));

						oimOrders.setDeliveryCity(StringHandle.removeComma(order2.getShippingAddress()
								.getCity()));
						oimOrders.setDeliveryCompany(StringHandle.removeComma(order2
								.getShippingAddress().getAddressLine3()));
						oimOrders.setDeliveryCountry(StringHandle.removeComma(order2
								.getShippingAddress().getCounty()));
						oimOrders.setDeliveryEmail(StringHandle.removeComma(order2.getBuyerEmail()));
						oimOrders.setDeliveryName(StringHandle.removeComma(order2.getShippingAddress()
								.getName()));
						oimOrders.setDeliveryPhone(StringHandle.removeComma(order2.getShippingAddress()
								.getPhone()));
						oimOrders.setDeliveryState(StringHandle.removeComma(order2.getShippingAddress()
								.getStateOrRegion()));
						oimOrders.setDeliveryStreetAddress(StringHandle.removeComma(order2
								.getShippingAddress().getAddressLine1()));
						oimOrders.setDeliverySuburb(StringHandle.removeComma(order2.getShippingAddress()
								.getAddressLine2()));
						oimOrders.setDeliveryZip(StringHandle.removeComma(order2.getShippingAddress()
								.getPostalCode()));
					}
