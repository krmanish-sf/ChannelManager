...
public class OimOrderDetails implements java.io.Serializable {
  ...
  public OimOrderDetails(OimOrderStatuses oimOrderStatuses, OimOrders oimOrders,
      OimSuppliers oimSuppliers, String sku, Double costPrice, Double salePrice, Date processingTm,
      Date insertionTm, Date deleteTm, Integer quantity, String productName, String productDesc) {
  ...
  public Set<OimOrderTracking> getOimOrderTracking() {
