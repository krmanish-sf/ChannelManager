...
function notifit_setDefaultValues() {
  ...
  position = "center";
  autohide = true;
  msg = "No Message Define";
  opacity = ' 0.8'; // Default opacity (Only Chrome, Firefox and Safari)
  multiline = false;
  fade = true;
  bgcolor = "#444";
  color = "#EEE";
...
function notif(config) {
  ...
  var div = "<div id='ui_notifIt' onmouseover=''><p>" + ((config.msg) ? config.msg : "") + "</p></div>";
  ...
  switch (position) {
    case "center":
      $("#ui_notifIt").css("top", 0); //css("top", parseInt(0 - (height + 10)));
      break;
    case "right":
  ...
  switch (config.type) {
    case "error":
      $("#ui_notifIt").addClass("alert-message error");
      break;
    case "success":
      $("#ui_notifIt").addClass("alert-message success");
      break;
    case "info":
      $("#ui_notifIt").addClass("alert-message info");
      break;
    case "warning":
      $("#ui_notifIt").addClass("alert-message warning");
      break;
    default:
      $("#ui_notifIt").addClass("alert-message default");
      break;
  }
  ...
  switch (position) {
    case "center":
      $("#ui_notifIt").animate({top: 15}).animate({top: 0});
      break;
    case "right":
