...
$.extend($.jgrid,{
	...
	search : {
		...
		Find: "Chercher",
		Reset: "R?initialiser",
		odata: [{ oper:'eq', text:"?gal"},{ oper:'ne', text:"diff?rent"},{ oper:'lt', text:"inf?rieur"},{ oper:'le', text:"inf?rieur ou ?gal"},{ oper:'gt', text:"sup?rieur"},{ oper:'ge', text:"sup?rieur ou ?gal"},{ oper:'bw', text:"commence par"},{ oper:'bn', text:"ne commence pas par"},{ oper:'in', text:"est dans"},{ oper:'ni', text:"n'est pas dans"},{ oper:'ew', text:"finit par"},{ oper:'en', text:"ne finit pas par"},{ oper:'cn', text:"contient"},{ oper:'nc', text:"ne contient pas"}],
