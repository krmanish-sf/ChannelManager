...
$.extend($.jgrid,{
	...
	edit : {
		...
		bCancel: "Odustani",
		bClose: "Zatvori",
		saveData: "Podatak je izmjenjen! Sa?uvaj izmjene?",
		bYes : "Da",
		bNo : "Ne",
		bExit : "Odustani",
		msg: {
			...
			minValue:"vrijednost mora biti ve?a od ili jednaka sa ",
			...
			customarray : "Prilago?ena funkcija treba da vrati niz!",
			customfcheck : "Prilago?ena funkcija treba da bude prisutana u slu?aju prilago?ene provjere!"
	...
	nav : {
		...
		deltext: "",
		deltitle: "Izbri?i izabran red",
		searchtext: "",
		searchtitle: "Na?i zapise",
		refreshtext: "",
		refreshtitle: "Ponovo u?itaj podatke",
		alertcap: "Upozorenje",
	...
	errors : {
		...
		model : "Du?ina modela colNames <> colModel!"
	},
	formatter : {
