...
$.extend($.jgrid,{
	...
	search : {
	    ...
	    Find: "Find",
	    Reset: "Nulstil",
	    odata: [{ oper:'eq', text:"lig"},{ oper:'ne', text:"forskellige fra"},{ oper:'lt', text:"mindre"},{ oper:'le', text:"mindre eller lig"},{ oper:'gt', text:"st?rre"},{ oper:'ge', text:"st?rre eller lig"},{ oper:'bw', text:"begynder med"},{ oper:'bn', text:"begynder ikke med"},{ oper:'in', text:"findes i"},{ oper:'ni', text:"findes ikke i"},{ oper:'ew', text:"ender med"},{ oper:'en', text:"ender ikke med"},{ oper:'cn', text:"indeholder"},{ oper:'nc', text:"indeholder ikke"}],
	...
	edit : {
		...
		bExit : "Fortryd",
	    msg: {
	        required:"Felt er n?dvendigt",
	        number:"Indtast venligst et validt tal",
	        minValue:"v?rdi skal v?re st?rre end eller lig med",
	        maxValue:"v?rdi skal v?re mindre end eller lig med",
	        email: "er ikke en gyldig email",
	        integer: "Indtast venligst et gyldigt heltal",
			date: "Indtast venligst en gyldig datov?rdi",
			url: "er ugyldig URL. Prefix mangler ('http://' or 'https://')",
			nodefined : " er ikke defineret!",
			novalue : " returv?rdi kr?ves!",
	...
	nav : {
		...
		addtext:" ",
	    addtitle: "Tilf?j ny linje",
	    deltext: " ",
	    deltitle: "Slet valgte linje",
	    searchtext: " ",
	    searchtitle: "Find linjer",
	    refreshtext: "",
	    refreshtitle: "Indl?s igen",
	    alertcap: "Advarsel",
	    alerttext: "V?lg venligst linje",
		viewtext: "",
	...
	errors : {
	    ...
	    model : "colNames og colModel har ikke samme l?ngde!"
	},
	formatter : {
